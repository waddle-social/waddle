...
<template>
  <AppDialog v-model:open="open">
    <div class="border-b border-border px-5 py-4 flex items-center justify-between">
      <h2 class="text-[15px] font-semibold">Waddle Settings</h2>
    ...
    <div class="px-5 py-4 space-y-4">
      ...
      <div>
        ...
        <div class="flex gap-1.5">
          <button
            class="flex-1 text-[13px] font-medium py-2 px-3 rounded-md transition-all flex items-center justify-center gap-1.5 border"
    ...
    <div class="border-t border-border px-5 py-3 flex items-center justify-between">
      <button
        class="text-[13px] font-medium py-1.5 px-3 rounded-md text-destructive hover:bg-destructive/10 transition-colors"
        @click="emit('delete')"
      >
        Delete Waddle
      </button>
