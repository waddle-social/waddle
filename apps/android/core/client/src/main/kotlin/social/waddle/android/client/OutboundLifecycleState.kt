...
internal sealed interface AttemptCloseOutcome { data object Closed : AttemptCloseOutcome
data object AlreadyClosed : AttemptCloseOutcome
data object OwnedBySessionShutdown : AttemptCloseOutcome
data class FencedWithPending(val component: LifecyclePendingComponent, val pending: Int) : AttemptCloseOutcome
...
data class WorkerFenced(val lifecycle: SessionLifecycleRef, val cause: LifecycleFenceCause) : LifecycleShutdownOutcome
data class FencedWithPending(val lifecycle: SessionLifecycleRef, val component: LifecyclePendingComponent, val pending: Int) : LifecycleShutdownOutcome
