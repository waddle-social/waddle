<template>
  <div class="community-app">
    ...
    <div class="floating-orb w-72 h-72 top-10 right-10 animate-float"></div>
    <div class="floating-orb w-96 h-96 bottom-20 left-20 animate-float-delayed"></div>
    <div class="floating-orb w-64 h-64 top-1/2 right-1/4 animate-float"></div>
...
/* Chat view doesn't need wrapper styling since ChatContent handles its own */
.chat-view {
  padding: 1rem;
}
