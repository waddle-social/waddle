...
pub use session_registry::{
    DetachedPresenceState, DetachedSession, DetachedUnackedStanza, InMemorySmSessionRegistry,
    RecentTombstoneRecord, SmClaimCompletion, SmRegistryError, SmSessionRegistry,
