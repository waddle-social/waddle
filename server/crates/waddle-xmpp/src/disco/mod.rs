...
pub use info::{
    ...
    parse_disco_info_query, pubsub_service_features, push_service_features, server_features,
    spaces_service_features, upload_service_features, DiscoInfoQuery, Feature, Identity,
    DISCO_INFO_NS,
};
pub use items::{
