...
pub(super) async fn list_all_sessions_with_unacked(
        ...
        .map_err(|e| SmPersistenceError::Other(e.to_string()))?
    {
        ...
        if starts_new_group {
            ...
            // `occupancy_session` at 3,
            // `presence_payloads` at 18)
        ...
        // original_receipt_at_ms (21) — shifted by `occupancy_session`
        // (session column 3) and
        // `presence_payloads` (session column 18).
