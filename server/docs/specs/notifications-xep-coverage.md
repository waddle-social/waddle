...
| Blocked sender suppresses push | XEP-0191 (privacy lists / blocking command) | 8 tests in `notification_outbox.rs`: `xep0191_blocks_notification_candidate`, `xep0191_full_jid_block_suppresses_dm_push_candidate`, `xep0191_domain_block_suppresses_dm_push_candidate`, `xep0191_blocked_dm_outbox_job_does_not_publish_push_notification`, plus 4 more |
