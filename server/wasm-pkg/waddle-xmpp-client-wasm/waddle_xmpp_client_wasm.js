...
import wasmUrl from "./waddle_xmpp_client_wasm_bg.wasm?url&b=mplknu9s";
import * as bgModule from "./waddle_xmpp_client_wasm_bg.js?b=mplknu9s";
import { __wbg_set_wasm } from "./waddle_xmpp_client_wasm_bg.js?b=mplknu9s";
...
export * from "./waddle_xmpp_client_wasm_bg.js?b=mplknu9s";
