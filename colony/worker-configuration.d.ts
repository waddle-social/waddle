/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a95510d8693c54b441115ff5fbdd86e9)
// Runtime types generated with workerd@1.20260410.1 2026-03-12 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		BETTER_AUTH_SECRET: SecretsStoreSecret;
		GITHUB_CLIENT_SECRET: SecretsStoreSecret;
		WADDLE_SERVER_OIDC_CLIENT_SECRET: SecretsStoreSecret;
		ASSETS: Fetcher;
		BETTER_AUTH_URL: "https://colony.waddle.social";
		GITHUB_CLIENT_ID: "Ov23liag5CB15O5sIQ60";
		WADDLE_SERVER_OIDC_REDIRECT_URLS: "https://api.waddle.social/api/auth/callback";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "WADDLE_SERVER_OIDC_REDIRECT_URLS">> {}
}
