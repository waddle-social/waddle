...
export default defineConfig({
  ...
  theme: {
    extend: {
      tokens: {
        ...
        fonts: {
          display: { value: "'Space Grotesk Variable', 'Space Grotesk', system-ui, sans-serif" },
          body: { value: "'Outfit Variable', 'Outfit', system-ui, sans-serif" },
  ...
  globalCss: {
    ...
    a: { color: "inherit", textDecoration: "none", _hover: { color: "action.hover" } },
    "p a, li a": { color: "action.text", textDecoration: "underline", textUnderlineOffset: "2px" },
  },
