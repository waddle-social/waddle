...
| Permission check API | ⬜ Not Started | P0 | [Spec: Permissions](specs/permission-model.md) |
| MUC affiliation sync | ⬜ Not Started | P0 | [RFC-0002](rfcs/0002-channels.md), [Spec: XMPP](specs/xmpp-integration.md) |
| **Core Messaging** |
