...
| 0107 | User Mood | Draft | Status moods | Implemented | Chat ✓ |
| 0108 | User Activity | Draft | Custom activity status | Implemented | Chat ✓ |
| 0118 | User Tune | Draft | "Now playing" music status | Implemented | Chat ✓ |
...
| 0448 | Encryption for Stateless File Sharing | Experimental | Encrypted file sharing | Implemented | Chat ✓ |
...
| **0430** | **Inbox** | Deferred | Unified inbox / unread counts | Implemented | Chat ✓ |
