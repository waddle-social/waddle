...
| XEP | Title | Status | Why Evaluate |
|-----|-------|--------|--------------|
| 0166 | Jingle | Implemented (Draft) | Session negotiation (handler-backed IQ routing/validation for MUC room occupants) |
| 0167 | Jingle RTP Sessions | Implemented (Draft) | Audio/video RTP description parsing/building |
