...
| **0410** | **MUC Self-Ping** | Draft | Detect disconnection from rooms |
| **0421** | **Occupant Identifiers for Semi-Anonymous MUCs** | Draft | Stable anonymous identities |
...
| **0401** | **Ad-hoc Account Invitation Generation** | Experimental | Generate invite links |
...
| XEP | Title | Status | Why Evaluate |
|-----|-------|--------|--------------|
| 0166 | Jingle | Draft | Session negotiation |
| 0167 | Jingle RTP Sessions | Draft | Audio/video calls |
| 0176 | Jingle ICE-UDP Transport | Draft | NAT traversal |
| 0215 | External Service Discovery | Draft | TURN/STUN discovery |
| 0272 | Multiparty Jingle (Muji) | Experimental | Group calls |
...
| **0471** | **Calendar Events** | Experimental | Community events |
| **0472** | **Pubsub Social Feed** | Experimental | Activity feeds |
| **0501** | **Pubsub Stories** | Experimental | Ephemeral stories |
...
| **0215** | **External Service Discovery** | Draft | External services |
